#!/usr/bin/env python3
"""
🔧 Setup Telephony - Configuration interactive

Configure facilement votre connexion téléphonique!
...
def print_header():
    print()
    print("=" * 60)
    print("📞 Open Medical Secretary - Configuration Téléphonie")
    print("=" * 60)
    print()


def print_providers():
    print("Choisissez votre opérateur SIP:\n")
    print("  1. OVH Télécom (recommandé pour la France)")
    print("  2. Twilio (international)")
    print("  3. Free SIP (Freebox)")
    print("  4. Autre opérateur SIP")
    print()


def get_ovh_config():
    """Get OVH SIP configuration."""
    print("\n📋 Configuration OVH Télécom")
    print("-" * 40)
    print("Connectez-vous à: https://www.ovhtelecom.fr/manager/")
    print("Allez dans: Téléphonie > Votre ligne > Configuration SIP\n")
...
def get_twilio_config():
    ...
    print("-" * 40)
    print("Connectez-vous à: https://console.twilio.com/")
    print("Allez dans: Elastic SIP Trunking > Trunks\n")
    
    print("Créez un trunk et notez:")
...
def get_free_config():
    ...
    print("\n📋 Configuration Free SIP (Freebox)")
    print("-" * 40)
    print("Connectez-vous à: https://subscribe.free.fr/login/")
    print("Allez dans: Téléphonie > Gestion SIP\n")
...
def get_custom_config():
    ...
    print("\n📋 Configuration SIP personnalisée")
    print("-" * 40)
...
def test_connection(config: dict):
    ...
    try:
        ...
        if result == 0:
            ...
            print("   ⚠️ Serveur non accessible (normal si UDP uniquement)")
...
3. Testez avec un appel entrant sur votre numéro!

📞 Configuration Asterisk:
   - Les appels entrants sont automatiquement routés vers l'IA
